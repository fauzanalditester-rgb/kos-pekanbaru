...
<head>
    ...
    <title>{{ $title ?? 'Harsasetialiving - Kamar Kos Pekanbaru' }}</title>
...
<body class="bg-gray-50 text-gray-800 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <a href="/" class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-bold bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">Harsasetialiving</span>
                </a>
    ...
    <footer class="bg-gray-900 text-gray-400 py-12 mt-16">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <p class="text-sm font-semibold text-white mb-1">Harsasetialiving Pekanbaru</p>
            <p class="text-xs">&copy; {{ date('Y') }} Harsasetialiving. All rights reserved.</p>
        </div>
    </footer>
