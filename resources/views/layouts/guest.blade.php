...
<head>
    ...
    <title>Login - {{ config('app.name', 'Harsasetialiving') }}</title>
...
<body class="h-full antialiased font-sans text-[#333333] selection:bg-[#FFCC00] selection:text-[#333333] bg-[#FAFAFA]">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        <a href="/" wire:navigate class="flex flex-col items-center gap-4 mb-8">
            ...
            <span class="text-3xl font-extrabold tracking-tight text-[#333333]">Harsasetia<span class="text-[#FFCC00] font-medium">living</span></span>
        </a>
