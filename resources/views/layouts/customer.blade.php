...
<head>
    ...
    <title>{{ $title ?? 'Customer Portal - Harsasetialiving' }}</title>
    ...
    <div class="flex h-full">
        ...
        <aside id="sidebar" class="w-72 bg-[#111827] flex-shrink-0 flex flex-col fixed inset-y-0 left-0 z-40 transform -translate-x-full md:translate-x-0 transition-transform duration-300 border-r border-gray-800/50">
            ...
            <div class="p-6 flex items-center">
                <a href="/customer" class="flex items-center gap-3.5 group w-full">
                    ...
                    <div>
                        ...
                        <span class="text-[10px] text-gray-500 font-bold tracking-widest uppercase">Customer</span>
                    </div>
                </a>
            </div>
                    ...
                    <div class="flex items-center gap-3 px-4 py-3 border-b border-gray-800/50">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="px-1.5 py-0.5 bg-green-500/20 text-green-400 text-[9px] rounded">Cust</span>
                            </div>
                        </div>
                    </div>
