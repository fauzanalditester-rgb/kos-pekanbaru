            ...
            <div class="bg-[#111827] border border-gray-800/50 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <form wire:submit="saveTenant" class="p-6 space-y-4">
                    <div>
                        ...
                        <select wire:model="property_id" wire:change="$refresh" class="w-full bg-gray-900 border border-gray-700 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#0d9488]">
                    ...
                    @elseif($viewingTenant->id_card_photo)
                        ...
                        <div class="flex items-center justify-center">
                            <label class="cursor-pointer inline-flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 text-gray-300 text-sm font-medium rounded-lg transition-colors">
                                ...
                                Ganti KTP
                                <input type="file" wire:model="idCardFile" wire:change="uploadIdCard" class="hidden" accept="image/*">
                            </label>
                        </div>
                    @else
