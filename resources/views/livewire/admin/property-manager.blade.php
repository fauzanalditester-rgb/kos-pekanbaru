            ...
            <div class="bg-[#111827] border border-gray-800/50 rounded-2xl p-6 hover:border-[#0d9488]/30 transition-all">
                ...
                <div class="flex items-start justify-between mb-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button wire:click="deleteProperty({{ $property->id }})" wire:confirm="Apakah Anda yakin ingin menghapus properti ini?" class="p-2 text-gray-500 hover:text-red-500 transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
